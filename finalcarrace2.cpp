...
void jumpCar()
{
    ...
    if (carmx != 0)
    {
        if ( race[carmx - 8][carmy]  == '*') 
        {
            live --;
            score--;
            cartouchh();
        }
        else if(race[carmx - 7][carmy] == '*')
        {
            live --;
            score--;
            cartouchh();
        }
         else if(race[carmx - 6][carmy] == '*')
        {
            live --;
            score--;
            cartouchh();
        }
         else if(race[carmx - 5][carmy] == '*')
        {
            live --;
            score--;
            cartouchh();
    ...
    if (racetx != 0)
    {
        if ( race[racetx - 8][racety]  == '*') 
        {
            live --;
            score--;
            cartouchhh();
        }
        else if(race[racetx - 7][racety] == '*')
        {
            live --;
            score--;
            cartouchhh();
        }
         else if(race[racetx - 6][racety] == '*')
        {
            live --;
            score--;
            cartouchhh();
        }
         else if(race[racetx - 5][racety] == '*')
        {
            live --;
            score--;
            cartouchhh();
    ...
    if (racefx != 0)
    {
        if ( race[racefx - 8][racefy]  == '*') 
        {
            live --;
            score--;
            cartouch();
        }
        else if(race[racefx - 7][racefy] == '*')
        {
            live --;
            score--;
            cartouch();
        }
         else if(race[racefx - 6][racefy] == '*')
        {
            live --;
            score--;
            cartouch();
        }
         else if(race[racefx - 5][racefy] == '*')
        {
            live --;
            score--;
            cartouch();
